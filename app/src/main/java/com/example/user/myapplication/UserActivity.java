...
public class UserActivity extends AppCompatActivity {
    ...
    public void init() {
        ...
        buttonCreateBD.setVisibility(View.GONE);
        ...
        buttonCreateBD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                flights.add(new Flight("5555", "06:00", "11:00", "Tel-aviv", "Berlin"));
                flights.add(new Flight("6666", "07:00", "09:00", "Madrid", "Budapest"));
                flights.add(new Flight("7777", "08:00", "13:00", "Barcelona", "Tel-aviv"));
                flights.add(new Flight("8888", "09:00", "14:00", "Amsterdam", "Tel-aviv"));
